            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-3">
                   {movies?.length ? movies.map((movie) => {
                    return(
                        <Link href={`/dashboard/movies/${movie.id}`} className="block p-4 bg-white rounded-lg shadow hover:shadow-lg transition-shadow border-l-4 border-blue-500 hover:border-blue-600 text-slate-800 hover:text-blue-600" key={movie.id}>
